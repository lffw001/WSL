...
class WSLCE2EContainerCreateTests
{
    ...
    TEST_METHOD(WSLCE2E_Container_Create_DNS_SingleServer)
    {
        WSL2_TEST_ONLY();
    ...
    TEST_METHOD(WSLCE2E_Container_Create_DNS_MultipleServers)
    {
        WSL2_TEST_ONLY();
    ...
    TEST_METHOD(WSLCE2E_Container_Create_DNS_Search)
    {
        WSL2_TEST_ONLY();
    ...
    TEST_METHOD(WSLCE2E_Container_Create_DNS_Option)
    {
        WSL2_TEST_ONLY();
    ...
    TEST_METHOD(WSLCE2E_Container_Create_DNS_AllOptions)
    {
        WSL2_TEST_ONLY();
