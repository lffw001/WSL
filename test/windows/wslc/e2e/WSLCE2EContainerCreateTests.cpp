...
class WSLCE2EContainerCreateTests
{
    ...
    TEST_METHOD(WSLCE2E_Container_Create_NamedVolume_WriteFromContainerReadFromContainer)
    {
        WSL2_TEST_ONLY();
    ...
    TEST_METHOD(WSLCE2E_Container_Create_NamedVolume_PersistsBetweenContainers)
    {
        WSL2_TEST_ONLY();
